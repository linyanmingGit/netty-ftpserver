...
public interface Ftplet {
     ...
     * @throws IOException
     */
    FtpletResult beforeCommand(FtpChannel channel, FtpRequest request)
	 ...
	 * @throws IOException
	 */
    FtpletResult afterCommand(FtpChannel channel, FtpRequest request, FtpReply reply)
            throws FtpException, IOException;
     ...
     * @throws IOException 
     */
    FtpletResult onConnect(FtpChannel channel) throws FtpException, IOException;
     ...
     * @throws IOException 
     */
    FtpletResult onDisconnect(FtpChannel channel) throws FtpException, IOException;
}