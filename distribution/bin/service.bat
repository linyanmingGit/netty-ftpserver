...
"%EXECUTABLE%" //IS//%SERVICE_NAME% --StartClass io.netty.ftpserver.main.Daemon --StartParams %CMD_LINE_ARGS% --StartPath "%FTPD_HOME%" --StopClass io.netty.ftpserver.main.Daemon --StopParams stop
