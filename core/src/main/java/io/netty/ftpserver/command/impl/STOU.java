...
public class STOU extends AbstractCommand {
        ...
        try {
            ...
            try {
                ...
                if (pathName == null) {
                    ...
                    FtpFile dir = channel.getFileSystemView().getFile(
                            pathName);
                    if (dir.isDirectory()) {
                ...
                file = channel.getFileSystemView().getFile(filePrefix);
                if (file != null) {
                    file = getUniqueFile(channel, file);
                }
            } catch (Exception ex) {
            ...
            // get data connection
            channel.writeAndFlush(new DefaultFtpReply(FtpReply.REPLY_150_FILE_STATUS_OKAY, "FILE: " + fileName));
    ...
    protected FtpFile getUniqueFile(FtpChannel ftpChannel, FtpFile oldFile)
            throws FtpException {
        FtpFile newFile = oldFile;
        FileSystemView fsView = ftpChannel.getFileSystemView();
